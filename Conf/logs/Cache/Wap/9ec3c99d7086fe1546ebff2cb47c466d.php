...
<script src="<?php echo RES;?>/css/flash/js/iscroll.js"
...
.copyright{padding:8px;text-align:center;font-size:11px;color:#ccc;}
...
<script src="<?php echo RES;?>/js/card/copyright.js" type="text/javascript"></script>
<input type="hidden" value="<?php echo (htmlspecialchars_decode($token)); ?>" id="token">
	<input type="hidden" value="<?php echo (htmlspecialchars_decode($wecha_id)); ?>" id="wecha_id">
 <div class="copyright"  ><a href="http://wx.wozongla.net/index.php?g=Wap&m=Index&a=index&token=aitewangluo"><?php echo htmlspecialchars_decode(C('copyright')) ?></a></div> 
