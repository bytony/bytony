...
<div class="content">
	...
	<div class="cLineB">
		<h4>
			文章分类管理 <span class="FAQ">设置好分类，在图文编辑的时候就可以选择分类，系统会自动生成一个3G网站。</span>
		</h4>

	</div>
	<div class="cLineC" style="line-height: 32px;">
		<a target="ddd" href="<?php echo U('Classify/add');?>"
			class="btnGrayS vm bigbtn">添加文章分类</a>
		<a target="_blank" href="<?php echo U('Wap/Index/index',array('token'=>$_SESSION['token']));?>" class="btnGrayS vm bigbtn" style="position:relative;right:0;">查看效果</a>
	</div>
				...
				<table class="ListProduct" border="0" cellSpacing="0"
					...
					<thead>
						<tr>
							...
							<th>分类图片外链地址(宽720高400) <a target="999" class="tooltips"><img
							...
							<th>外链网站或活动 <span class="tooltips"><img
									src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
										<p>
											比如你想跳转到百度，就填写<a class="red">http://www.baidu.com</a>
										</p>
										<p>不需要跳转就不用填写，还可以外链活动，</p>
										<p>
											直接填写活动外链地址：<a class="red">大转盘387</a>
										</p>
								</span></span></th>
					...
					<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><div class="cateimg">
								<img src="<?php echo ($vo["img"]); ?>" class="cateimg_small" /><img
									src="<?php echo ($vo["img"]); ?>" class="cateimg_big" />
							</div></td>
						...
						<td class="norightborder">
							<a target="ddd"
							href="<?php echo U('Classify/edit',array('id'=>$vo['id']));?>">编辑</a>
