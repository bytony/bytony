            ...
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR>
                  ...
                  <TD><input type="text" class="px" id="keyword" value=""  name="keyword" style="width:580px;height:24px;"><br />
                  多个关键词请用空格格开：例如: 美丽&nbsp;漂亮&nbsp;好看 </TD>
                </TR>
                 <TR>
			  <TH valign="top">关键词类型：</TH>
			  <TD>
			  <label for="radio1"><input id="radio1" class="radio" type="radio" name="type" value="2"  /> 完全匹配  用户输入的和此关键词一样才会触发!</label>
			  <br />
			  <label for="radio2"><input class="radio" id="radio2" type="radio" name="type" value="1" /> 包含匹配 (只要用户输入的文字包含本关键词就触发!v2用户才生效)</label></TD>
			</TR>
              </THEAD>
              <TBODY>
               <TR>
                  <TH><span class="red">*</span><label for="title">二级页面标题：</label></TH>
                  <TD><input type="text" class="px" id="title" value=""    name="title" style="width:580px;height:24px;"> </TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="text">二级页面简介：</label></TH>
                  <TD><textarea  class="px" id="Hfcontent" name="text" style="width:580px;  height:100px"></textarea><br />限制200字内
				</TD>
                </TR>
				<TR>
                  <TH valign="top"><label for="pic">二级页面图片地址：</label></TH>
