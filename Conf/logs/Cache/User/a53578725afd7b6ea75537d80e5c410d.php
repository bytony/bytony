...
<div class="content">
          ...
          <form method="post"   action="<?php echo U('LocalCoupon/insert');?>"  enctype="multipart/form-data" >
              ...
              <TBODY>
               ...
               <TR>
                ...
                <TR>
                  ...
                  <TD><input type="input" name="couponnum"  value="<?php echo ($list["couponnum"]); ?>" class="px" style="width:400px;height:24px"/><br />
			           	</TD>
                </TR>
                  <TR>
