...
<div class="content">
	...
	<div class="cLine">
		<div class="pageNavigator left">
			<a
				href='<?php echo U("Img/add");?>' title='新增二级图文回复'
				class='btnGrayS vm bigbtn'><img
				src="<?php echo RES;?>/images/pic.png" class="vm" />新增二级图文页面</a>
			<a href='<?php echo U("Thirdimg/add");?>' title='新增三级图文回复'
				class='btnGrayS vm bigbtn'><img
				src="<?php echo RES;?>/images/pic.png" class="vm" />新增三级图文回复</a> 
		</div>
		...
		<TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0"
			...
			<TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><div class="answer_text">
							<img src="<?php echo RES;?>/images/pic.png" class="vm"
								title="图文自定义内容"><?php echo ($vo["text"]); ?>
						</div></td>
					...
					<td class="norightborder">
						...
						<a href="<?php echo U('Img/edit',array('id'=>$vo['id']));?>"
						title="编辑图文自定义回复">编辑</a> <a
						href="<?php echo U('Img/del',array('id'=>$vo['id']));?>">删除</a>
					</td>

				</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				<?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><tr>

					<td></td>
					<td><?php echo ($so["title"]); ?></td>
					<td><div class="answer_text">
							<img src="<?php echo RES;?>/images/pic.png" class="vm"
								title="图文自定义内容"><?php echo ($so["text"]); ?>
						</div></td>
					<td><?php echo ($so["imgtitle"]); ?></td>
					<td><?php echo ($so["click"]); ?></td>
					<td><?php echo date('Y-m-d',$so['uptatetime']); ?></td>

					<td class="norightborder">
						<!--a target="ddd" href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a-->
						<a href="<?php echo U('Thirdimg/edit',array('id'=>$so['id']));?>"
						title="编辑图文自定义回复">编辑</a> <a
						href="<?php echo U('Thirdimg/del',array('id'=>$so['id']));?>">删除</a>
					</td>
