...
<div class="nav-header">推广活动</div>
	...
	<li   <?php if(MODULE_NAME == 'LocalCoupon'): ?>class="selected" <?php else: ?>class="subCatalogList"<?php endif; ?> > <a href="<?php echo U('LocalCoupon/index',array('token'=>$token));?>">本地优惠券</a></li>
...
<div class="content">
          <div class="cLineB"><h4>编辑本地优惠券信息</h4><a href="<?php echo U('LocalCoupon/index');?>"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div>
         
          <form method="post"   action="<?php echo U('LocalCoupon/edit');?>"  enctype="multipart/form-data" >
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
                ...
                <td><input type="input" class="px" id="keyword" value="<?php echo ($list["keyword"]); ?>" name="keyword" style="width:400px;height:24px;"><br>
                  <span class="red">只能写一个关键词</span>，用户输入此关键词将会触发此活动。</td>
                </TR>
                <TR><th><span class="red">*</span>商户名：</th>
                  <td><input class="px" id="name" value="<?php echo ($list["name"]); ?>" name="name" style="width:400px;height:24px;"><br>
                </TR>
               <TR>
                  <TH><span class="red">*</span><label for="title">优惠券图片：</label></TH>
                  <TD><input type="text" class="px" id="title" value="<?php echo ($list["imgurl"]); ?>"    name="imgurl" style="width:400px;height:24px;"> <br />推荐将图片上传到腾讯微薄再获取外链</TD>
                </TR>
                <tr>
                  <th><span class="red">*</span>活动时间：</th>
                  <td><input type="input" class="px" id="starttime" value="<?php if($list['starttime'] != ''): echo (date("Y-m-d",$list["starttime"])); else: echo date('Y-m-d',mktime(0, 0, 0, date("m") , date("d"), date("Y"))); endif; ?>" onClick="WdatePicker()" name="starttime" />                
                    到
                    <input type="input" class="px" id="endtime" value="<?php if($list['endtime'] != ''): echo (date("Y-m-d",$list["endtime"])); else: echo date('Y-m-d',mktime(0, 0, 0, date("m") , date("d")+3, date("Y"))); endif; ?>" name="endtime" onClick="WdatePicker()"  /> 
                  </td>
                </tr>
                <TR>
                  <TH valign="top"><span class="red">*</span>优惠券数量：</TH>
                  <TD><input type="input" name="couponnum"  value="<?php echo ($list["couponnum"]); ?>" class="px" style="width:200px;height:24px"/> 剩余优惠券数量：<input name="residuenum" value="<?php echo ($list["residuenum"]); ?>" class="px" style="width:200px;height:24px"/><br />
			           	</TD>
                </TR>
                  <TR>
                  <TH valign="top"><span class="red">*</span>联系地址：</TH>
                  <TD><input name="address"  class="px" value="<?php echo ($list["address"]); ?>" style="width:400px;height:24px"/><br />
                  </TD>
                </TR>
                 <TR>
                  <TH valign="top"><span class="red">*</span>联系电话：</TH>
                  <TD><input name="tel"  class="px" value="<?php echo ($list["tel"]); ?>" style="width:400px;height:24px"/><br />
                  </TD>
                </TR>
                    <TR>
                ...
                <TR>
                  <TH></TH>
                  <TD><input type="submit" value="保存" name="sbmt" class="btnGreen left">　<a href="<?php echo U('LocalCoupon/index');?>"  class="btnGray vm">取消</a></TD>
                </TR>
              </TBODY>
            </TABLE>
