...
<div class="content">
	...
	<div class="cLineB">
		<h4>
			本地优惠券管理 <span class="FAQ">开通本地优惠券，在图文内容详情页面显示优惠券信息</span>
		</h4>

	</div>
	<div class="cLineC" style="line-height: 32px;">
		<a target="ddd" href="<?php echo U('LocalCoupon/add');?>"
			class="btnGrayS vm bigbtn">添加本地优惠券</a>
				...
				<table class="ListProduct" border="0" cellSpacing="0"
					...
					<thead>
						<tr>
							...
							<th style="width: 120px;">优惠券商家</th>
							<th style="width: 70px;">优惠券数量</th>
							<th>本地优惠券图片外链地址(宽720高400) <a target="999" class="tooltips"><img
									src="<?php echo RES;?>/images/price_help.png" align="absmiddle" /><span>
										<p>分类图片最佳尺寸：宽720高400</p>
										<p>不支持上传图片，请把图片上传到腾讯微博，再这里填写图片的外链地址。</p>
										<p>如果不填写分类图片地址系统将分配默认图片。</p>
								</span></a></th>
							<th style="width: 120px;">地址</th>
							<th style="width: 80px;">联系方式</th>
							<th style="width: 120px;">开始时间/结束时间</th>
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($list["couponnum"]); ?></td>
						<td><div class="cateimg">
								<img src="<?php echo ($list["imgurl"]); ?>" class="cateimg_small" /><img
									src="<?php echo ($list["imgurl"]); ?>" class="cateimg_big" />
							</div></td>
						<td><?php echo ($list["address"]); ?></td>
						<td><?php echo ($list["tel"]); ?></td>
						<td><?php echo (date('Y-m-d',$list["starttime"])); ?><br /><?php echo (date('Y-m-d',$list["endtime"])); ?></td>

						<td class="norightborder">
							<a target="ddd"
							href="<?php echo U('LocalCoupon/edit',array('id'=>$list['id']));?>">编辑</a>
							<a href="<?php echo U('LocalCoupon/del',array('id'=>$list['id']));?>">删除</a>
						</td>
