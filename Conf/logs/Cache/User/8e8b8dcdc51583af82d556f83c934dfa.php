...
<div class="content">
          ...
          <form method="post"   action="<?php echo U('Thirdimg/insert');?>"  enctype="multipart/form-data" >
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
               ...
               <TR>
                  <TH><span class="red"></span><label for="title">三级页面标题：</label></TH>
                  <TD><input type="text" class="px" value=""  name="title" style="width:580px;height:24px;"> </TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="text">三级页面简介：</label></TH>
                  <TD><textarea  class="px" id="Hfcontent" name="text" style="width:580px;  height:100px"></textarea><br />限制200字内
				</TD>
                </TR>
				<TR>
                  <TH valign="top"><label for="pic">三级页面图片地址：</label></TH>
                  <TD><input class="text textMiddle inputQ"  name="pic" value="" style="width:580px;"  /><br />
               		   推荐将图片上传到腾讯微薄再获取外链
				  </TD>
                </TR>
               <TR>
                  <TH valign="top"><label for="classid">所属二级页面：</label></TH>
                  <TD>
                   <select name="imgid">
                      <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option   value="<?php echo ($vo["id"]); ?>,<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
                    </select><a href="<?php echo U('Img/add');?>"  target="ddd" >添加二级页面</a>
                  </TD>
                </TR>
               <TR>
                ...
                <TR>
                 ...
                 <TR>
                  ...
                  <TD><input type="input" class="px" id="url" value="" name="url" style="width:580px;height:26px;"><br /><span class="red">如需跳转到其他网址，请在这里填写网址(例如：http://baidu.com，记住必须有http://)</span>如果填写了图文详细内容，这里请留空，不要设置！</TD>
                </TR>
                <TR>
                  <TH></TH>
