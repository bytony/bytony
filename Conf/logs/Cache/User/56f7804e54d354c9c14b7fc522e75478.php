...
<li class="addli" id="addpublic"><a class="addwx" title="添加微信公众号" onclick="location.href='<?php echo U('Index/add');?>';">添加微信公众号</a></li>
<li style="height:47px;line-height:47px;color:red;padding:10px;">一个账号只能添加一个公众号，如需添加多个，请联系QQ：2662834750</li>
</ul>
        <div class="clr"></div>
      </div>
          <div class="msgWrap">
	...
	publicnumber++;
		...
		<script>
		if(publicnumber >= 1){
			document.getElementById('addpublic').style.display="none";
