...
<div class="nav-header">推广活动</div>
	...
	<li   <?php if(MODULE_NAME == 'LocalCoupon'): ?>class="selected" <?php else: ?>class="subCatalogList"<?php endif; ?> > <a href="<?php echo U('Coupon/index2',array('token'=>$token));?>">本地优惠券</a></li>
...
<div class="content">
    ...
    <div class="msgWrap form">
        <ul id="tags">
            ...
            <li><a onclick="selectTag('tagContent2',this)" href="javascript:void(0)">3.图文类型模板风格</a> </li>
            <li><a onclick="selectTag('tagContent3',this)" href="javascript:void(0)">4.图文详细页模板风格</a> </li>
            <div class="clr"></div>
        </ul>
        ...
        <div id="tagContent">
                    ...
                    <ul class="cateradio2">
                        ...
                        <li <?php if(($info["tpllistid"]) == "1"): ?>class="active"<?php endif; ?>>
			 			 ...
			 			 <li <?php if(($info["tpllistid"]) == "5"): ?>class="active"<?php endif; ?>>
                            <label><img src="<?php echo RES;?>/images/cate2.png">
                                <input class="radio2" type="radio" name="optype2" value="5" <?php if(($info["tpllistid"]) == "5"): ?>checked<?php endif; ?> /> 模板3(户型)
                            </label>
                        </li>
						<li <?php if(($info["tpllistid"]) == "6"): ?>class="active"<?php endif; ?>>
                            <label><img src="<?php echo RES;?>/images/cate1.png">
                                <input class="radio2" type="radio" name="optype2" value="6" <?php if(($info["tpllistid"]) == "6"): ?>checked<?php endif; ?> /> 模板4(产品)
                            </label>
                        </li>
                    </ul>
                </fieldset>
            ...
            <div class="tagContent" id="tagContent2">
                <fieldset>
                    <ul class="cateradio3">
						 <li <?php if(($info["tpllist2id"]) == "2"): ?>class="active"<?php endif; ?> >
                            <label><img src="<?php echo RES;?>/images/list4.png">
                                <input class="radio3" type="radio" name="optype3" <?php if(($_SESSION['gid']) == "2"): ?>disabled="disabled"<?php endif; ?> value="2" <?php if(($info["tpllist2id"]) == "2"): ?>checked<?php endif; ?> /> 模板2(省流量)
                            </label>
                        </li>
                        <li <?php if(($info["tpllist2id"]) == "1"): ?>class="active"<?php endif; ?>>
                            <label><img src="<?php echo RES;?>/images/list1.png">
                                <input class="radio3" type="radio" name="optype3" value="1" <?php if(($info["tpllist2id"]) == "1"): ?>checked<?php endif; ?> /> 模板1(美观)
                            </label>
                        </li>
                         <li <?php if(($info["tpllist2id"]) == "3"): ?>class="active"<?php endif; ?>>
                            <label><img src="<?php echo RES;?>/images/list1.png">
                                <input class="radio3" type="radio" name="optype3" value="3" <?php if(($info["tpllist2id"]) == "3"): ?>checked<?php endif; ?> /> 模板3(菜谱)
                            </label>
                        </li>
                    </ul>
                </fieldset>
            ...
            <div class="tagContent" id="tagContent3">
                <fieldset>
                    <ul class="cateradio4">
                        <li <?php if(($info["tplcontentid"]) == "1"): ?>class="active"<?php endif; ?> ><label><img src="<?php echo RES;?>/images/news1.png"><input class="radio4" type="radio" name="optype4" value="1" <?php if(($info["tplcontentid"]) == "1"): ?>checked<?php endif; ?>/>模板1(有头像) </label></li>
                        <li <?php if(($info["tplcontentid"]) == "3"): ?>class="active"<?php endif; ?> ><label><img src="<?php echo RES;?>/images/news3.png"><input class="radio4" type="radio" name="optype4" value="3" <?php if(($info["tplcontentid"]) == "3"): ?>checked<?php endif; ?>/>模板3(无头像)</label></li>
                    </ul>
                </fieldset>
            </div>
            <div class="tagContent" id="tagContent4">
                <fieldset>
                    <div class="cateradio5">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td valign="top"><h3>请选择你喜欢的颜色风格，实时预览 (<span style="color:#c30">注意：只有在手机上才能获得最佳浏览效果，电脑浏览并不一定是最终显示效果，并且仅部分模板支持更换颜色风格</span>)</h3>
                                        <ul>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="0" <?php if(($info["color_id"]) == "0"): ?>checked="checked"<?php endif; ?>> 默认风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="1" <?php if(($info["color_id"]) == "1"): ?>checked="checked"<?php endif; ?>> 黑色风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="2" <?php if(($info["color_id"]) == "2"): ?>checked="checked"<?php endif; ?>> 蓝色风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="3" <?php if(($info["color_id"]) == "3"): ?>checked="checked"<?php endif; ?>> 木纹风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="4" <?php if(($info["color_id"]) == "4"): ?>checked="checked"<?php endif; ?>> 橙色风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="5" <?php if(($info["color_id"]) == "5"): ?>checked="checked"<?php endif; ?>> 紫色风格</label></li>
                                            <li><label><input class="radio5" type="radio" name="optype5" value="6" <?php if(($info["color_id"]) == "6"): ?>checked="checked"<?php endif; ?>> 绿色风格</label></li>
                                        </ul>
                                    </td>
                                </tr>
                            </tbody>
        ...
        <script>
            ...
            $(".radio3").click(function(){
                ...
                var myurl ='index.php?g=User&m=Tmpls&a=lists2&style='+$(this).val()+'&r='+Math.random(); 
                $.ajax({url:myurl,async:false});


            });
            $(".radio4").click(function(){
                $(".cateradio4 li").each(function(){
                    $(this).removeClass("active");
                });
                $(this).parents("li").addClass("active");
...
<!--div id="copyright" style="color:white">
	...
	技术支持：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=79177618&site=qq&menu=yes"><img height="20" border="0" src="http://wpa.qq.com/pa?p=2:79177618:51" alt="联系我吧" title="联系我吧"/></a>
	售前咨询：<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=79177618&site=qq&menu=yes"><img height="20" src="http://wpa.qq.com/pa?p=2:79177618:51" alt="联系我吧" title="联系我吧"/></a>
	...
	<div class="onlinebox-conbox" id="onlinebox-conbox" style="position: absolute; left: -94px; width: 118px; display:none;">
		...
		<div class="onlinebox-center">
			<div class="onlinebox-center-box">
				<dl>
					<dt>使用帮助</dt>
						<dd><a href="tencent://message/?uin=79177618&amp;Site=&amp;Menu=yes" title="QQ咨询服务">
						<img border="0" src="http://wpa.qq.com/pa?p=2:79177618:42"></a>
						</dd>
					</dl>
				<div class="clear"></div>
				<dl>
					<dt>技术询问</dt>
					<dd>
						<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=79177618&site=qq&menu=yes">
							<img border="0" src="http://wpa.qq.com/pa?p=2:79177618:42" alt="咨询服务" title="咨询服务"/>
						</a>
					</dd>
				</dl>
				<div class="clear"></div>
				<dl><dt>合作加盟</dt>
				<dd>
					<a href="tencent://message/?uin=79177618&amp;Site=&amp;Menu=yes" title="QQ合作加盟">
						<img border="0" src="http://wpa.qq.com/pa?p=2:79177618:47">
					</a>
				</dd>
				</dl>
				<div class="clear"></div>
